    ...
    <>
      ...
      <main className="pt-24 pb-16 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Story Section */}
          <div className=" dark:bg-dark-card rounded-2xl border border-gray-200 dark:border-dark-border p-8 mb-8 slide-in-up">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-gradient-to-br from-green-50 to-teal-50 dark:from-green-900/20 dark:to-teal-900/20 rounded-2xl border border-green-200 dark:border-green-800 p-6 scale-in" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-2xl border border-orange-200 dark:border-orange-800 p-6 scale-in" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl border border-purple-200 dark:border-purple-800 p-6 scale-in" style={{ animationDelay: '0.3s' }}>
          ...
          {/* Mission Section */}
          <div className="bg-gradient-to-r from-primary-600 to-purple-600 rounded-2xl p-8 text-center text-white mb-8 slide-in-up">
          ...
          {/* CTA Section */}
          <div className="text-center dark:bg-dark-card rounded-2xl border border-gray-200 dark:border-dark-border p-8">
            ...
            <Link
              href="/dashboard"
              className="inline-block px-8 py-4 bg-primary-600 text-white rounded-lg font-semibold hover:bg-primary-700 transition-all transform hover:scale-105 shadow-lg shadow-primary-600/30"
            >
              Start Taking Notes
            </Link>
          </div>
